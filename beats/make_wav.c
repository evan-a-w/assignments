...
void write_wav (
    ...
    write_little_endian(
        36 + bytes_per_sample * num_samples * num_channels, 4, wav_file);
    ...
    write_little_endian(
        bytes_per_sample * num_samples * num_channels, 4, wav_file);
    for (i = 0; i < num_samples; i++) {
        write_little_endian(
            (unsigned int) (data[i]), bytes_per_sample, wav_file);
    }
